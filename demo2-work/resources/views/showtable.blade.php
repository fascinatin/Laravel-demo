...
<div class="rg_layout">
<div class="rg_left">
	<p class="p_reg">请输入要修改的信息</p>
	<p class="p_en">USER REGISTER</p>
</div>

<div class="rg_center">
	<div class="re_form">
		
    <form id="form1" name="form1" method="post" action="/updatetable?id={{$data->userid}}" >
			<table>
				<tr>
					<td class="td_left"><label for="username">用户名</label></td>
					<td class="td_right"><input type="text" id="name" name="name" value='{{$data->username}}'></td>
				</tr>
