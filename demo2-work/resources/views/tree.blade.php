...
var treeMenu = [
	{ level:1, name:"用户管理"},
	{ level:2, name:"用户列表", ico:"images/icon_default.gif",link:"/admininsert"},
	{ level:2, name:"账号管理"},
	{ level:3, name:"账号更新与注销", ico:"images/icon_default.gif",link:"/update"},
	{ level:3, name:"添加用户", ico:"images/icon_default.gif",link:"/insert"},
	{ level:3, name:"添加管理员", ico:"images/icon_default.gif",link:"/admininsert"},
	{ level:1, name:"商品管理"},
	{ level:2, name:"商品上架", ico:"images/icon_default.gif",link:"/insertshop"},
	{ level:2, name:"商品更新", ico:"images/icon_default.gif",link:"/shopupdate"},
	{ level:1, name:"系统管理", ico:"images/icon_default.gif"},
	{ level:1, name:"邮箱信息", ico:"images/icon_default.gif",link:"complaint_list.html"},
	{ level:1, name:"订单管理"},
	{ level:2, name:"订单更新", ico:"images/icon_default.gif",link:"news_list.html"},
	{ level:2, name:"订单溯源", ico:"images/icon_default.gif",link:"bulletin_list.html"},
];
</script>
<style>
* {
