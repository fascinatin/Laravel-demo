		...
		<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
				...
				<section id="tm-section-1" class="tm-section">
					<div class="tm-bg-transparent-black tm-contact-box-pad">
						<div class="row mb-4">
							<div class="col-sm-12">
								<header><h2 class="tm-text-shadow">管理员登录</h2></header>
							</div>
						</div>
						<div class="row tm-page-4-content">
							<div class="col-md-6 col-sm-12 tm-contact-col">
								<div class="contact_message">
									<form action="/admincheck" method="post" id="form1" name="form1" class="contact-form">
										<div class="form-group">
											<input type="text" id="contact_name" name="adminname" class="form-control" placeholder="请输入用户名" required="">
										</div>
										<div class="form-group">
